...
const EmployeeList = () => {
  const [employees, setEmployees] = useState([
    ...
    { id: 4, name: 'Bob Williams', position: 'Sales Manager', department: 'Sales' },
    { id: 1, name: 'John Doe', position: 'Software Engineer', department: 'Engineering' },
    { id: 2, name: 'Jane Smith', position: 'UX Designer', department: 'Design' },
    { id: 3, name: 'Alice Johnson', position: 'Marketing Specialist', department: 'Marketing' },
    { id: 4, name: 'Bob Williams', position: 'Sales Manager', department: 'Sales' },
        ...
        <table className="w-full border-collapse border">
          <thead className="bg-gray-200 sticky top-0">
            <tr>
              ...
              <th className="border px-6 py-3">Position</th>
          ...
          <tbody className="overflow-y-auto ">
            {filteredEmployees.map(employee => (
              <tr key={employee.id}>
                ...
                <td className="border px-6 py-3">{employee.position}</td>
